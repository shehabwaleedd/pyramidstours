...
const TestimonialCard = ({ testimonial, isSelected, onDetailsOpen, onDetailsClose }: { testimonial: Testimonial, isSelected: boolean, onDetailsOpen: () => void, onDetailsClose: () => void }) => {
    ...
    return (
        <div className={styles.cardContainer}>
            <div className={styles.card}>
                ...
                <p>{isExpanded ? testimonial.description : testimonial.description.slice(0, 150) + (testimonial.description.length > 150 ? '...' : '')}</p>
                {testimonial.description.length > 150 && (
                    <button onClick={handleToggleDetails} className={styles.showMoreButton}>
