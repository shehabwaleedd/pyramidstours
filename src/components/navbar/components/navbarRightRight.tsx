...
const NavbarRightRight = ({ toggleProfileOpen, toggleWishlistOpen, wishlistCount, toggleDesktopNavOpen }: { toggleProfileOpen: () => void, toggleWishlistOpen: () => void, wishlistCount: number, toggleDesktopNavOpen: () => void }) => {
